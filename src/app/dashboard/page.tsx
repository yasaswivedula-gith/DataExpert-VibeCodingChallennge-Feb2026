        ...
        {activeTab === "tasks" && (
          <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
            ...
            <div className="space-y-3">
              {tasks.map((task) => (
                <div key={task.id} className="flex items-center justify-between p-4 bg-neutral-800/50 rounded-lg">
                  <div className="flex items-center gap-4">
                    <input
                      type="checkbox"
                      ...
                      className="w-5 h-5 rounded bg-neutral-700 border-neutral-600"
                    />
                    <div>
          ...
          <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
            ...
            <div className="space-y-3">
              {workflows.map((workflow) => (
                <div key={workflow.id} className="flex items-center justify-between p-4 bg-neutral-800/50 rounded-lg">
                  <div className="flex items-center gap-4">
          ...
          <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {aiSuggestions.map((suggestion) => (
                <div key={suggestion.id} className="p-4 bg-neutral-800/50 rounded-lg border border-neutral-700">
